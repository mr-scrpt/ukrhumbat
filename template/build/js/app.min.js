...
;// CONCATENATED MODULE: ./src/js/module/utils.js


const hoverElement = (className) => {
...
;// CONCATENATED MODULE: ./src/js/module/input.js
...
/**************/
jquery(() => {
  const $inputsControl = jquery('.input__control')
  $inputsControl.on('focus', ({ target }) => {
    const $item = jquery(target.closest('.input'))
...
jquery(() => {
  ...
  $labels.each((_, item) => {
    const $labelCurrent = jquery(item)
...
;// CONCATENATED MODULE: ./src/js/module/textarea.js
...
jquery(document).ready(() => {
  ...
  $textarea.on('focus', ({ target }) => {
    const $item = jquery(target.closest('.textarea'))
...
;// CONCATENATED MODULE: ./src/js/module/checkbox.js
...
/**************/
jquery(() => {
  const $checkboxList = jquery('.checkbox')
...
jquery(() => {
  const $inputs = jquery('.checkbox')
  $inputs.on('mouseover', ({ target }) => {
    const $item = jquery(target.closest('.checkbox'))
...
;// CONCATENATED MODULE: ./src/js/module/radio.js
...
/**************/
jquery(() => {
  const $radioGroup = jquery('.radio-group')

  $radioGroup.each((_, radioBlock) => {
    const $radioBlock = jquery(radioBlock)

    $radioBlock.on('click', (e) => {
      const $radio = jquery(e.target.closest('.radio'))
...
;// CONCATENATED MODULE: ./src/js/module/slider.js
...
core.use([Navigation, Pagination, Autoplay, Thumb])
// News slider
jquery(() => {
  const [navNext] = jquery('.news__nav-next')
  const [navPrev] = jquery('.news__nav-prev')
  sliderGen('.news .swiper', optionsNews({ navNext, navPrev }))
})

// Result slider
jquery(() => {
  const [navNext] = jquery('.result__nav-next')
  const [navPrev] = jquery('.result__nav-prev')
...
// Support slider
jquery(() => {
  const [navNext] = jquery('.support__nav-next')
  const [navPrev] = jquery('.support__nav-prev')
...
// Support slider
jquery(() => {
  const [navNext] = jquery('.team__nav-next')
  const [navPrev] = jquery('.team__nav-prev')
...
const sliderCheckBrakepoint = (sliderClass, options, bp) => {
  ...
  const $sliderElem = jquery(sliderClass)
...
const sliderGen = (block, option) => new core(block, option)
